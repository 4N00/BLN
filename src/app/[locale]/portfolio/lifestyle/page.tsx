...
const lifestyleImages = [
  ...
  {
    id: 6,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 6 Modal pages.jpg",
    alt: "Lifestyle portret in natuurlijke omgeving",
    caption: "Where light meets life",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 7,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 7 Modal pages.jpg",
    alt: "Intiem familieportret - warme connectie",
    caption: "Warmth in every glance",
    year: "2024",
    size: "small",
    position: "left",
    aspectRatio: "3/4",
  ...
  {
    id: 8,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 8 Modal pages.jpg",
    alt: "Spontaan lifestyle moment vastgelegd",
    caption: "Unscripted and unforgettable",
    year: "2023",
    size: "medium",
    position: "right",
    aspectRatio: "3/4",
  ...
  {
    id: 9,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 9 Modal pages.jpg",
    alt: "Portretfotografie met natuurlijk licht",
  ...
  {
    id: 10,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 10 Modal pages.jpg",
    alt: "Lifestyle fotografie - emotioneel moment",
    caption: "Feelings framed forever",
    year: "2023",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 11,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 11 Modal pages.jpg",
    alt: "Familie lifestyle sessie buitenshuis",
  ...
  {
    id: 12,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 12 Modal pages.jpg",
    alt: "Authentiek portret met zachte tonen",
    caption: "Soft light, real moments",
    year: "2024",
    size: "small",
    position: "right",
    aspectRatio: "3/4",
  ...
  {
    id: 13,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 13 Modal pages.jpg",
    alt: "Lifestyle fotografie - persoonlijk verhaal",
    caption: "A chapter worth remembering",
    year: "2023",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 14,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 14 Modal pages.jpg",
    alt: "Natuurlijke portretfotografie in beweging",
  ...
  {
    id: 15,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 15 Modal pages.jpg",
    alt: "Lifestyle sessie - verbinding en emotie",
    caption: "The beauty of being present",
    year: "2023",
    size: "medium",
    position: "right",
    aspectRatio: "3/4",
  ...
  {
    id: 16,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 16 Modal pages.jpg",
    alt: "Creatieve lifestyle portretfotografie",
    caption: "Creativity captured naturally",
    year: "2024",
    size: "medium",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 17,
    src: "/images/PORTFOLIO/LIFESTYLE /PORTFOLIO LIFESTYLE 17 Modal pages.jpg",
    alt: "Tijdloos lifestyle portret door Loes Nooitgedagt",
    caption: "Timeless by nature",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
