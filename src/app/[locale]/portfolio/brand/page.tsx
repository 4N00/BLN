...
const brandImages = [
  {
    id: 1,
    src: "/images/PORTFOLIO/Brand/BRAND 1 - SOMMARA.jpg",
    alt: "Merkfotografie Sommara door Loes Nooitgedagt",
    caption: "Visual identity that resonates",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 2,
    src: "/images/PORTFOLIO/Brand/BRAND 2 - MARTENS&MEIJER-23.jpg",
    alt: "Merkfotografie Martens & Meijer",
    caption: "Elevating your presence",
    year: "2024",
    size: "small",
    position: "right",
    aspectRatio: "3/2",
  ...
  {
    id: 3,
    src: "/images/PORTFOLIO/Brand/BRAND 3 - ATELIERLIGNE.jpg",
    alt: "Merkfotografie Atelier Ligne",
  ...
  {
    id: 4,
    src: "/images/PORTFOLIO/Brand/BRAND 3 - TOPMARK .jpg",
    alt: "Merkfotografie Topmark",
    caption: "Authenticity meets aesthetics",
    year: "2024",
    size: "small",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 5,
    src: "/images/PORTFOLIO/Brand/BRAND 4 - NIJNTJE.jpg",
    alt: "Merkfotografie Nijntje",
    caption: "Playful charm, captured",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/4",
  ...
  {
    id: 6,
    src: "/images/PORTFOLIO/Brand/BRAND 5- FLEVOPADEL.jpg",
    alt: "Merkfotografie Flevopadel",
    caption: "Energy in every frame",
    year: "2024",
    size: "medium",
    position: "right",
    aspectRatio: "3/2",
  ...
  {
    id: 7,
    src: "/images/PORTFOLIO/Brand/BRAND 6 - DE BRASS.jpg",
    alt: "Merkfotografie De Brass",
    caption: "Atmosphere speaks volumes",
    year: "2024",
    size: "small",
    position: "left",
    aspectRatio: "3/2",
  ...
  {
    id: 8,
    src: "/images/PORTFOLIO/Brand/BRAND 7 - MOWY.jpg",
    alt: "Merkfotografie Mowy",
    caption: "Beauty in every angle",
    year: "2024",
    size: "medium",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 9,
    src: "/images/PORTFOLIO/Brand/BRAND 8 - ICLICKS.jpg",
    alt: "Merkfotografie iClicks",
    caption: "Innovation meets image",
    year: "2024",
    size: "small",
    position: "right",
    aspectRatio: "3/2",
  ...
  {
    id: 10,
    src: "/images/PORTFOLIO/Brand/BRAND 9 - DE BRASS.jpg.jpg",
    alt: "Merkfotografie De Brass sfeerbeeld",
  ...
  {
    id: 11,
    src: "/images/PORTFOLIO/Brand/BRAND 10 - FLEVOPADEL.jpg",
    alt: "Merkfotografie Flevopadel actie",
  ...
  {
    id: 12,
    src: "/images/PORTFOLIO/Brand/BRAND 11 - ATELIER LIGNE.jpg",
    alt: "Merkfotografie Atelier Ligne portret",
  ...
  {
    id: 13,
    src: "/images/PORTFOLIO/Brand/BRAND 12 - DE BRASS.jpg",
    alt: "Merkfotografie De Brass interieur",
    caption: "Spaces that inspire",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 14,
    src: "/images/PORTFOLIO/Brand/BRAND 13 - LEO_S.jpg",
    alt: "Merkfotografie Leo's",
    caption: "Character in every shot",
    year: "2024",
    size: "medium",
    position: "right",
    aspectRatio: "3/2",
  ...
  {
    id: 15,
    src: "/images/PORTFOLIO/Brand/BRAND 14 - ATELIERLIGNE.jpg",
    alt: "Merkfotografie Atelier Ligne detail",
    caption: "Refined by design",
    year: "2024",
    size: "small",
    position: "left",
    aspectRatio: "3/4",
  ...
  {
    id: 16,
    src: "/images/PORTFOLIO/Brand/BRAND 15 - MOWY BEAUTY.jpg",
    alt: "Merkfotografie Mowy Beauty",
  ...
  {
    id: 17,
    src: "/images/PORTFOLIO/Brand/BRAND 16 - PB.jpg",
    alt: "Merkfotografie PB",
    caption: "Bold and confident",
    year: "2024",
    size: "small",
    position: "right",
    aspectRatio: "3/2",
  ...
  {
    id: 18,
    src: "/images/PORTFOLIO/Brand/BRAND 17 - MARTEN & MEIJER.jpg",
    alt: "Merkfotografie Marten & Meijer",
    caption: "Heritage meets modern",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 19,
    src: "/images/PORTFOLIO/Brand/BRAND 18 - LOU&LOU.jpg",
    alt: "Merkfotografie Lou&Lou",
    caption: "Warmth in every detail",
    year: "2024",
    size: "medium",
    position: "left",
    aspectRatio: "3/2",
  ...
  {
    id: 20,
    src: "/images/PORTFOLIO/Brand/BRAND 19 - DE BRASS.jpg",
    alt: "Merkfotografie De Brass sfeer",
    caption: "A taste of the extraordinary",
    year: "2024",
    size: "small",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 21,
    src: "/images/PORTFOLIO/Brand/BRAND 20 - TOPMARK.jpg",
    alt: "Merkfotografie Topmark producten",
  ...
  {
    id: 22,
    src: "/images/PORTFOLIO/Brand/BRAND 21 - FOR FRIENDS.jpg",
    alt: "Merkfotografie For Friends",
    caption: "Connection through creativity",
    year: "2024",
    size: "large",
    position: "center",
    aspectRatio: "3/2",
  ...
  {
    id: 23,
    src: "/images/PORTFOLIO/Brand/BRAND 22 - TOP MARK.jpg",
    alt: "Merkfotografie Top Mark campagne",
    caption: "Your brand, beautifully told",
    year: "2024",
    size: "medium",
    position: "center",
    aspectRatio: "3/4",
...
export default function BrandPortfolioPage() {
  const t = useTranslations("Portfolio.brand");
  ...
  const localizedImages = brandImages.map((img) => {
